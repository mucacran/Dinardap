<div role="form" class="wpcf7" id="wpcf7-f13335-o1" lang="es-ES" dir="ltr">
    <div class="screen-reader-response"></div>
        <form action="/xxx-denuncias-reclamos-xxx-prueba/#wpcf7-f13335-o1" method="post" class="wpcf7-form" enctype="multipart/form-data" novalidate="novalidate">
            <div style="display: none;">
                <input type="hidden" name="_wpcf7" value="13335" />
                <input type="hidden" name="_wpcf7_version" value="5.1.3" />
                <input type="hidden" name="_wpcf7_locale" value="es_ES" />
                <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f13335-o1" />
                ...
                <input type="hidden" name="_wpcf7cf_options" value="{&quot;form_id&quot;:13335,&quot;conditions&quot;:[],&quot;settings&quot;:{&quot;animation&quot;:&quot;yes&quot;,&quot;animation_intime&quot;:200,&quot;animation_outtime&quot;:200,&quot;notice_dismissed&quot;:false}}" />
            </div>
            ...
            <div class="cf7-form-control textarea">
                <span class="wpcf7-form-control-wrap your-message">
                    <textarea name="your-message" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Contenido de la queja denuncia o reclamo *"></textarea>
                </span>
            </div>
            <div class="cf7-form-control">
                <div class="form-group">
                    <a href="http://www.cfn.fin.ec/wp-content/uploads/2016/02/formato_reclamos_ago_14.xls" download>descarga formulario y adjuntarlo (opcional)</a>
                </div>
                <div class="form-group">
                    <span class="wpcf7-form-control-wrap denuncias-reclamos-excel">
                        <input type="file" name="denuncias-reclamos-excel" size="40" class="wpcf7-form-control wpcf7-file" accept=".xlsx,.xls" aria-invalid="false" />
                    </span>
                </div>
            </div>
        <p><i class="fa fa-paper-plane" aria-hidden="true"></i> <input type="submit" value="Enviar" class="wpcf7-form-control wpcf7-submit" /></p>
